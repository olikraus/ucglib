...
mkdir ../../../../Ucglib_Arduino/examples/PowerDown
...
cp ../../../sys/arduino/PowerDown/*.ino ../../../../Ucglib_Arduino/examples/PowerDown/.
...
echo now create a release in gitub for Ucglib_Arduino, tag/name = ${ver}
# Relases in github:
# Tag: 1.02pre3
