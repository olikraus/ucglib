...
$builder -compile -logger=machine $hardware $tools $libs -fqbn=arduino:sam:arduino_due_x_dbg $vidpid -ide-version=10804 -build-path $tmpdir -warnings=none -build-cache $tmpdir $pref1 $pref2 $pref3 $pref4 $ino
...
# upload
/home/kraus/.arduino15/packages/arduino/tools/bossac/1.6.1-arduino/bossac -i --port=ttyACM0 -U false -e -w -v -b $tmpdir/$ino.bin -R 
