...
//Ucglib4WireSWSPI ucg(ucg_dev_ssd1351_18x128x128_ilsoft, ucg_ext_ssd1351_18, 13, 11, /*cd=*/ 9 , /*cs=*/ 10, /*cs=*/ 8);	/* Arduino Uno */
//Ucglib4WireSWSPI ucg(ucg_dev_ssd1351_18x128x128_ilsoft, ucg_ext_ssd1351_18, 76, 75, /*cd=*/ 9 , /*cs=*/ 10, /*cs=*/ 8);	/* Arduino Due */
